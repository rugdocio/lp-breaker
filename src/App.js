  ...
  return (
    <Web3Context.Provider value={{ web3, chainId }} >
      <div className="App">
        ...
        <p/>
        <p  style={{ color: "#6d84a2" }}>Make sure that you're connected to the correct network (Supported: BSC, Polygon, Avalanche, Fantom, IOTEX, Moonriver, Celo, Harmony ONE, KCC and Moonbeam)</p>
      </div>
